    ...
    public partial class ecommerceContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<sig_signature>(entity =>
            {
                ...
                entity.Property(e => e.created_date).HasDefaultValueSql("'NULL'");
                ...
                entity.Property(e => e.is_approved)
                    .HasColumnType("int(11)")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<sig_signature_details>(entity =>
            {
                ...
                entity.Property(e => e.signature_id)
                    .HasColumnType("int(11)")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<ut_user>(entity =>
            {
                ...
                entity.Property(e => e.company).HasDefaultValueSql("'NULL'");
